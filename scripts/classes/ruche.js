 ...
 */
{
    ...
    var typeNode = {idTypeVar:this.nb_typeVariable-1, id:50+this.nb_typeVariable, pId:10000, name:TypeVariableDerivee.prototype.nomAffiche};
    ...
    var noeudObjet = zTree_Menu.getNodesByFilter(function(noeud) {
                                                 if (noeud.id < 11000 && noeud.id>9999 && noeud.name==catObjet) {
                                                 return true;
                                                 } else {return false;};
                                                 },true);
    ...
    var noeudMatiere = zTree_Menu.getNodesByFilter(function(noeud) {
                                                   if (noeud.id < 12000 && noeud.id>10999 && noeud.name==catMatiere) {
                                                   return true;
                                                   } else {return false;};
    ...
    if (noeudMatiere ==null && catMatiere != "") {
        ...
        if (noeudParentNext !=null) {idNoeudParentNext =noeudParentNext.id;}
        noeudMatiere = {idTypeVar:-3, id:10999+this.nb_typeVarCategorie[1], pId:idNoeudParentNext, name:catMatiere};
    ...
    var noeudSection = zTree_Menu.getNodesByFilter(function(noeud) {
                                                   if (noeud.id < 13000 && noeud.id>11999 && noeud.name==catSection) {
                                                   return true;
                                                   } else {return false;};
                                                   },true,noeudParentNext);
    if (noeudSection ==null && catSection != "") {
        ...
        var idNoeudParentNext=0;
        if (noeudParentNext !=null) {idNoeudParentNext=noeudParentNext.id;}
        noeudSection = {idTypeVar:-4, id:11999+this.nb_typeVarCategorie[2], pId:idNoeudParentNext, name:catSection};
 ...
 */
{
    ...
    if (numRepSauve>this.nb_reponse) {this.nb_reponse = Number(numRepSauve);}
 ...
 */
{
    if (typeof elemRecup != 'undefined')
    {
        ...
        if (elemRecup.numero > this.nb_essaim) {this.nb_essaim = elemRecup.numero;}
 ...
 */
{
    ...
    setTimeout(function(){$(".Rcl_OK_Light_SaveLoad").css("visibility","hidden")},300);
}
